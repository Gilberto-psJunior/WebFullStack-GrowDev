...
select * from compras where usuario_id=1

select * from produtos,compras
inner join usuarios 
on usuarios.id = compras.id


select usuarios.nome,data_compra ,produtos.nome,produtos.id from produtos,compras 
inner join usuarios
on usuarios.id=1

select usuarios.nome,produtos.nome,usuarios.id,produtos.id from usuarios,produtos 
inner join compras
on produtos.id=1